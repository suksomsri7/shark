// WO 1.2 — หน้าเอกสาร 1 ใบของใบกำกับภาษีซื้อ (PTX)
...
export default async function Page({
  ...
  return <ExpenseDetailPage systemId={id} docId={docId} slug="purchase-tax-invoice" err={sp.err} tab={sp.tab} msg={sp.msg} />;
}
