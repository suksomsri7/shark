...
// WO 1.6 — DNR เข้าทาง wizard 2 ขั้น (§5.2 J · ภาพ g3): ขั้น ① เลือกเอกสารอ้างอิง (PUR/EXP) → ขั้น ② ฟอร์มเดิม
...
const DOC_TYPE = "DEBIT_NOTE_RECEIVED" as const;
const DOC_LABEL = "รับใบเพิ่มหนี้";
...
export default async function Page({
  ...
  if (showStep1) {
    ...
    const pathname = `${base}/debit-note-received/new`;
    ...
    return (
      <AdjustWizardStep1
        ...
        cancelHref={`${base}/debit-note-received`}
      />
    );
  }
