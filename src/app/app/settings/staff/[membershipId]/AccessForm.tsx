    ...
    <form action={action} className="flex flex-col gap-6">
      ...
      <section className="card flex flex-col gap-3">
        ...
        <p className="text-xs text-[color:var(--color-muted)]">
          เจ้าของกิจการทำได้ทุกอย่าง · ผู้จัดการทำได้เกือบทุกอย่าง ยกเว้นงานตั้งค่าของ CRM (ตั้งค่าระบบ · คีย์ API · ออกแบบวัตถุ · การมองเห็นข้อมูล · ทีมขาย) ซึ่งเจ้าของร้านต้องติ๊กให้เป็นรายคน · การติ๊กสิทธิ์อื่นด้านล่างมีผลกับ “พนักงาน”
        </p>
      </section>
