...
export const SYSTEM_DEFS: SystemDef[] = [
  ...
  { code: "SHOP", no: 21, kind: "business", label: "ร้านค้าออนไลน์", hint: "catalog ตะกร้า จ่าย PromptPay", icon: "🛍️", status: "available" },
  ...
  { code: "POS", no: 14, kind: "feature", label: "ขายหน้าร้าน POS", hint: "ขาย บิล ยอดขาย", icon: "🧾", status: "available" },
  ...
  { code: "KB", no: 16, kind: "feature", label: "คลังความรู้ (KB)", hint: "FAQ/ความรู้ร้าน ให้ AI และทีมใช้ตอบ", icon: "📚", status: "available" },
  { code: "HR", no: 17, kind: "feature", label: "พนักงาน HR", hint: "ทะเบียนพนักงาน ลงเวลา ลา เงินเดือน", icon: "🧑‍💼", status: "available" },
  { code: "INVENTORY", no: 18, kind: "feature", label: "สินค้า/บริการ", hint: "สินค้า บริการ สต็อก รับเข้า-ตัดออก แจ้งใกล้หมด", icon: "📦", status: "available" },
