...
const MODULE_DEFS: readonly ModuleDef[] = [
  ...
  },
  {
    ...
    label: "สมาชิก/ลูกค้า",
    group: "customer",
    // M1.3 (§6.1): ชุดคีย์ v2 ครบ 30 ตัว + คีย์เดิม 5 ตัวที่ไม่อยู่ในชุด v2 (tier.update/plan.*/subscription.*
    // — โมดูลแพ็กเกจ/สมัครสมาชิกรายงวดเดิมยังเรียกอยู่จริงใน subscription-actions.ts/tier-actions.ts)
    // 🔴 คีย์ที่ทับกัน (customer.create/update/import) ใช้ป้าย v2 — ไม่พิมพ์ซ้ำสอง entry
    actions: {
      "member.customer.read": "ดูข้อมูลสมาชิก",
      "member.customer.create": "เพิ่มสมาชิกใหม่",
      "member.customer.update": "แก้ไขข้อมูลสมาชิก",
      "member.customer.merge": "รวมสมาชิกที่ซ้ำกัน",
      "member.customer.import": "นำเข้าสมาชิกจากไฟล์",
      "member.customer.export": "ส่งออกรายชื่อสมาชิก",
      "member.customer.delete": "ลบข้อมูลสมาชิกถาวร (คำขอ PDPA)",
      "member.sensitive.read": "ดูข้อมูลอ่อนไหวของสมาชิก",
      "member.tier.read": "ดูระดับสมาชิก",
      "member.tier.manage": "จัดการระดับสมาชิกและกฎเลื่อนระดับ",
      "member.tier.setManual": "ตั้งระดับสมาชิกด้วยมือ",
      "member.point.read": "ดูแต้มสะสม",
      "member.point.adjust": "ปรับแต้มด้วยมือ",
      "member.point.transfer": "โอนแต้มระหว่างสมาชิก",
      "member.loyalty.read": "ดูสแตมป์และรางวัล",
      "member.loyalty.manage": "จัดการสแตมป์และรางวัล",
      "member.loyalty.stamp": "ประทับสแตมป์ให้สมาชิก",
      "member.loyalty.fulfil": "ส่งมอบของรางวัล",
      "member.promo.read": "ดู voucher/คูปอง/โปรโมชัน",
      "member.promo.issue": "ออก voucher/คูปองให้สมาชิก",
      "member.promo.manage": "จัดการเทมเพลตโปรโมชัน/journey/แคมเปญ",
      "member.giftcard.sell": "ขายบัตรกำนัล (gift card)",
      "member.giftcard.manage": "จัดการตั้งค่าบัตรกำนัล",
      "member.review.read": "ดูรีวิวลูกค้า",
      "member.review.reply": "ตอบกลับรีวิว",
      "member.referral.manage": "จัดการโปรแกรมแนะนำเพื่อน",
      "member.report.view": "ดูรายงานระบบสมาชิก",
      "member.settings.manage": "ตั้งค่าระบบสมาชิก (ฟิลด์/ระดับ/แต้ม)",
      "member.privacy.manage": "จัดการความเป็นส่วนตัว/PDPA ของระบบสมาชิก",
      "member.api.manage": "จัดการคีย์ API ของระบบสมาชิก",
      // ── คีย์เดิม (ก่อน v2) ยังใช้อยู่จริงใน tier-actions.ts/subscription-actions.ts — คงไว้ (backward compat) ──
      "member.tier.update": "ตั้งระดับสมาชิก (แบบเดิม)",
