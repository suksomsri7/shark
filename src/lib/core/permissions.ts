...
const MODULE_DEFS: readonly ModuleDef[] = [
  {
    ...
    // 🔴 ถอดธง 31 ส.ค. — `chat.conversation.read` (guard.ts) · `chat.ai.suggest` · `chat.translate.use`
    //    ถูกเรียกจริงแล้วโดย WO-CW3/CW4 · เหลือจองไว้ตัวเดียว
    planned: ["chat.example.manage"],
  },
  {
    module: "pos",
