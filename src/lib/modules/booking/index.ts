// booking/index.ts — facade ของโมดูล "ระบบจองคิว" (สร้างในใบ CRM v2 C2.4 · มติผู้คุมงาน C2.4 ข้อ 8)
//
...
// 🔴 ผู้ใช้วันนี้: `crm/activities.ts#calendar` (เส้น crm→booking ใน `scripts/fitness.mts` ALLOWED_EDGES พร้อมเหตุผล)
