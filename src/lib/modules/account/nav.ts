  ...
  return [
    ...
    // 2. รายรับ
    {
      ...
      items: [
        ...
        soon("นำเข้าเอกสาร", "import", "REVENUE_IMPORT", true),
    ...
    // 3. รายจ่าย
    {
      ...
      items: [
        ...
        soon("ใบจ่ายเงินมัดจำ", "cash", "DEPOSIT_PAYMENT"),
        doc({
        ...
        soon("รับใบลดหนี้", "in", "CREDIT_NOTE_RECEIVED"),
        soon("รับใบเพิ่มหนี้", "out", "DEBIT_NOTE_RECEIVED"),
