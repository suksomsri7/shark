...
// แถบสถานะเอกสาร (§1, §3 DESIGN-SPEC-V2): เลื่อนแนวนอนได้เมื่อยาว + ลูกศร › ท้ายแถบเมื่อล้น
// active = ตัวหนา + ขีดล่าง accent 2px · "พ้นกำหนด" ฯลฯ ใช้ tone="danger"
      ...
      <div ref={scrollerRef} className="flex gap-4 overflow-x-auto pb-px" role="tablist">
        {tabs.map((t) => {
          ...
          return (
            <Link
              key={t.key}
              href={buildHref(pathname, current, { [paramKey]: t.key, page: undefined })}
              role="tab"
