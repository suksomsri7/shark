...
const ICONS: Record<string, string> = {
  ...
  // WO 7.2 (g15 แผงขวา "ส่งรูปบิลเข้า LINE OA ของร้าน") — กรอบข้อความ ไม่ใช่ซองจดหมาย
  //   (ซองจดหมาย = ช่องทางอีเมล ซึ่งเป็นคนละบรรทัดในแบบเดียวกัน ใช้ไอคอนซ้ำ = อ่านไม่ออกว่าคนละทาง)
  chat: '<path d="M4.5 5.5h15a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H9l-4 3.2V15.5h-.5a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1Z"/>',
  // WO 9.4 — tooltip (?) หัวคอลัมน์/ฟิลด์บัญชี (HelpTip.tsx) — ต่างจาก `info` (วงกลม-i ใช้กับแถบแจ้งข้อมูล)
  help: '<circle cx="12" cy="12" r="8.5"/><path d="M9.6 9.4a2.5 2.5 0 0 1 4.8.9c0 1.7-2.4 1.9-2.4 3.5"/><path d="M12 17.3h.01"/>',
};
