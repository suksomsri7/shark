// IntegrationsSettings.tsx — บล็อก "การเชื่อมต่อ" ในหน้าตั้งค่าบอร์ดงาน (K3.2 → เปิดครบ 6 สวิตช์ใน K3.3)
...
// 🔴 "การ์ดจากอีเมล" ยังเป็น "เร็ว ๆ นี้" (สะพานอยู่ใน K3.9) — ปุ่มที่เปิดแล้วไม่เกิดอะไร = โกหก
"use client";
...
/** สวิตช์ที่ยังไม่มีสะพานจริง (K3.9 — อีเมลเข้าบอร์ด) */
...
export function IntegrationsSettings({
  ...
  return (
    <section data-testid="kanban-integrations" className="card flex flex-col gap-4 p-4">
      ...
      {/* ── สวิตช์ที่รอ K3.9 (อีเมลเข้าบอร์ด) ── */}
