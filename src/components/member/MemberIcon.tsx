...
const ICONS: Record<string, string> = {
  ...
  // M2.9 — หน้าลูกค้า `/m/*` (ภาพ 09): บัตร QR · กระเป๋า · เวลา · กระดิ่ง · ซองจดหมาย · ดินสอ · ส่งออก · กล่อง · เมนู
  qr: "<rect x=\"4\" y=\"4\" width=\"6.5\" height=\"6.5\" rx=\"1.2\"/><rect x=\"13.5\" y=\"4\" width=\"6.5\" height=\"6.5\" rx=\"1.2\"/><rect x=\"4\" y=\"13.5\" width=\"6.5\" height=\"6.5\" rx=\"1.2\"/><path d=\"M13.5 13.5h3v3h-3zM20 13.5v3M20 20h-3.5M13.5 20h.01\"/>",
  wallet: "<rect x=\"3\" y=\"6\" width=\"18\" height=\"13\" rx=\"2.4\"/><path d=\"M3 10h18\"/><circle cx=\"17\" cy=\"14.5\" r=\"1.2\"/>",
  ...
  edit: "<path d=\"M4 20h4l10-10a2.5 2.5 0 0 0-3.5-3.5L4.5 16.5Z\"/><path d=\"m14 7 3 3\"/>",
  out: "<path d=\"M12 15V4\"/><path d=\"m8 8 4-4 4 4\"/><path d=\"M4.5 14v4.5a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5V14\"/>",
  ...
  // M3.10 — ผู้ช่วย AI (ภาพ 27 ซ้าย: ประกายหน้าหัวข้อ "ผู้ช่วย AI — สมาชิก")
  sparkle: "<path d=\"M12 3.5 13.8 8.2 18.5 10l-4.7 1.8L12 16.5l-1.8-4.7L5.5 10l4.7-1.8Z\"/><path d=\"m18.5 15.5.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8Z\"/>",
  send: "<path d=\"M4 12 20 4l-4.5 16-3.5-6.5Z\"/><path d=\"M12 13.5 20 4\"/>",
