...
> ภาพประกอบ: `ledger/design-crm/` (14 ภาพ — ดู `README.md` ในโฟลเดอร์นั้น · UI ชุดเดียวกับระบบสมาชิก/บอร์ดงาน/บัญชี)
...
> ขั้นถัดไปเมื่อเจ้าของเคาะคำถาม §8: เขียนพิมพ์เขียว `docs/modules/20-crm-v2.md` + `docs/api/CRM-API.md` + `ledger/CRM-RUN.md` แบบเดียวกับชุดสมาชิก
