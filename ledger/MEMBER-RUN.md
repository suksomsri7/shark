...
| M2.8 | ✅ DONE 30/30 · ภาพ 06 ผ่าน · Fable แก้ข้อสอบ 4 จุด (S2.3 stamps=1 · S7.2 k3.3 ภาพอยู่คนละ worktree · m1.9 S2.1 consumer เลื่อนระดับก่อน · m1.7 S6.2 party ที่บัญชีอ้างไม่ anonymize) · ลบ cache ชั้น 3 ของ wallet แล้ว · หนี้: qc-pos-register MEM-2 (prod env) ต้องแก้ที่ M3.F | 10 ก.ย. | `HASH_M28` | `scripts/qc-member-m2.8.mts` · member-bridges.ts (composition root) · createSale memberChoices · regressions 8 ชุดผ่าน qc-all log |
