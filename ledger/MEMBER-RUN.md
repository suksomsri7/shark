...
| M1.6 | 🔁 ตีกลับรอบ 1 (ภาพ 10/11/12 เลย์เอาต์ไม่ตรง) · ตรรกะผ่าน 11/11 | 10 ก.ย. | — | import.ts/members-actions/duplicates-actions · หน้า members/new|import|duplicates · harness 1.6 ปรับ flow นำเข้า (กด ถัดไป) |
...
| M1.8 | 🔁 ตีกลับรอบ 1 (มือถือล้นแนวนอน + ตัวเลือกช่วงวัน) · 14/15 | 10 ก.ย. | — | sources.ts (links/attribution/report) · settings/sources · `wo-notes/member-M1.8.md` |
...
| M1.10 | ✅ DONE 12/12 · ภาพ 04/15 ผ่าน | 10 ก.ย. | (ดู §4) | หน้า tiers + tiers/[tierId] (บันได · TierRuleBuilder · benefits 10 ชนิด · ทดลองรัน · ประวัติ · แบบเสียเงิน) · `wo-notes/member-M1.10.md` |
| M1.11 | 🔨 ส่งแล้ว 25/26 (รอภาพ 27 · settings/api) · ข้อตัดสิน 4 ข้อรับ (origin.ts dynamic env · แกน REST additive · members.create idempotency key · addresses.set = หนี้ party) | 10 ก.ย. | — | registry 68 op · route /api/v1/member · bundle 3 · generator + skill shark-member-api · tools-member 22 · F13.7–9 · `wo-notes/member-M1.11.md` |
| M1.12 | 🔨 ส่งแล้ว 11/14 (รอภาพ 26/28) | 10 ก.ย. | — | chat-bridge.ts (linkContact/chatPanelFor/registerFromChat) · ChatMemberPanel · chat.contact.linked 3 ทะเบียน · `wo-notes/member-M1.12.md` |
| M2.1 | ⏳ oracle พร้อม (28 ข้อ) | — | — | `scripts/qc-member-m2.1.mts` |
...
| M2.6 | ⏳ oracle พร้อม (24 ข้อ) + สเปคภาพ 20 (ยังไม่มี TMP26 — เขียนตอนถึงใบ) | — | — | `scripts/qc-member-m2.6.mts` · migration `member_v2_f` · GiftCardSettings · PosSale.giftCardId · account facade postGiftCardSale/Use/Expire · ระบบบัญชีใน QC สร้างตอนรันข้อสอบ (ทิ้งไว้) |
