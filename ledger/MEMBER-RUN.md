...
| M2.4 | ✅ DONE 18/18 · ภาพ 05/18 ผ่าน (Fable แก้ข้อสอบ 2 จุด) · หนี้เล็ก: ชิป 'รอรับ' มือถือขึ้น 2 บรรทัด | 10 ก.ย. | `HASH_M2C` | `scripts/qc-member-m2.4.mts` · migration `member_v2_d2` (Reward/Redemption +cols — WO table เดิมเขียน "—" แต่คอลัมน์ยังไม่มีในสคีมา) |
| M2.5 | ✅ DONE 26/26 · ภาพ 19 ผ่าน (Fable แก้ข้อสอบ 3 จุด) · มติ builder ยอมรับ: approval/index.ts facade ใหม่ · registerMemberHooks เรียกตอนใช้งาน · idempotencyKey ไม่รวม reason · STAFF ออก PERCENT ไร้ cap ไม่ได้ | 10 ก.ย. | `HASH_M2C` | `scripts/qc-member-m2.5.mts` · VoucherIssueBatch (เก็บคำขอรออนุมัติ) · composition root `src/lib/member-hooks.ts` |
