...
| M2.7 | ✅ DONE 22/22 · ภาพ 02 แท็บกระเป๋า ผ่าน · มติ: applyOnSale รับ cart บังคับ (ข้อสอบแก้แล้ว) · หนี้→M2.8 ลบ cache ชั้น 3 · perf ≤6 query ทำไม่ได้ (~13 query ขนาน ≤0.6 วิ ยอมรับ) · coupon/index.ts + system/index.ts facade ใหม่ | 10 ก.ย. | `HASH_M27` | `scripts/qc-member-m2.7.mts` · member/wallet.ts · MEMBER_LIMITS.vouchersPerSale · stamp.previewForCart |
