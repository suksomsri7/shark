...
| ขั้นที่ถึง | 05:39 น.: K1.2 DONE (Opus 17 นาที · Fable: k1.2 25 · k1.1 30 · notify 12 · SQL ดูตาแล้ว · typecheck · fitness) → push main → **Fable รัน backfill B บน prod** · สั่ง Opus ทำ K1.3 |
...
| K1.3 | สมาชิกบอร์ด/ดาว (`KanbanBoardMember`/`KanbanBoardStar`) + สิทธิ์ 2 ชั้น (`boardRole()`) + คีย์สิทธิ์ใหม่ 8 + 404 + AuditLog | Opus | IN_PROGRESS | | `qc-kanban-k1.3.mts` (เขียนแล้ว 29 ข้อ) |
