...
| C2 | C2.1 | ✅ | (ใบนี้) | ตัวรันแอ็กชันร่วม (C18 · move-only จาก journeys) + กฎ scope CRM (trigger crm.*/cron 5 · เงื่อนไข 5 prefix · แอ็กชัน 14+CREATE_DEAL · กฎเริ่มต้น 6 · dry-run · โควตา · loop-guard) + UI ประโยคไทย · ข้อสอบ **84/84** (ผู้คุมงานรันเอง `c21-verify3.log` 26/26 ขั้น) · ถอยหลัง 13 ชุด · ORACLE-EDIT X4.4 + C0.2-S4.2/4.3 + C0.5-S4.4/4.5 · ACCEPTANCE-FIX เมนู · PARITY ผ่าน (Fable) · 🔴 ห้ามเปิดร้านนำร่องก่อน C6.1 (ไม่มี cron) · `wo-notes/crm-C2.1.md` |
| C2 | C2.2 | ✅ | (ใบนี้) | ลำดับการติดตาม: CRUD+versioning · enroll/bulk (เพดาน maxActive SQL คำสั่งเดียว+advisory lock) · runDue lease/วันทำการ/sendWindow · auto-stop 5 เหตุ + audit ใน tx · FAILED หลัง 5 ครั้ง · archive วนแบตช์ · ประตูสะพาน v1 · UI ตามแบบ 07 ล่าง (ภาพรวมการ์ดขั้น+ตารางผู้ลงทะเบียน) · ข้อสอบ **73/73** (65+8 ORACLE-EDIT) · ผู้ตรวจ 2 รอบ + builder 3 รอบ (บั๊กจริง: FAILED ไปไม่ถึงเพราะ 42P18 ถูกกลืน · archive >500 ซอมบี้ · แบนเนอร์เวอร์ชันอ่าน 500 แถว · regression c1.11 ×2) · PARITY ผ่าน · `wo-notes/crm-C2.2.md` |
| C2 | C2.3 | ✅ | (ใบนี้) | มอบหมาย lead: กฎเรียงลำดับ · เงื่อนไข 6 ชนิด (language ผ่านสะพาน chat/forms แล้ว) · FIXED/RR/TEAM_LEAD/LEAST_OPEN · ลา/ปิดรับ/เพดาน/สำรอง/NOBODY · pageData ไม่รั่วลา/อีเมล/ฟิลด์ลับ (รวม nextUserId/ทดลอง) · `f.<ลับ>` ปฏิเสธตอนบันทึก · teamId เฉพาะสมาชิกจริง · audit ใน tx · ข้อสอบ **80/80** (60+20 ORACLE-EDIT) · ผู้ตรวจ 2 รอบ (BLOCKER 3 รอบ 2) + builder 3 รอบ · PARITY ผ่าน · `wo-notes/crm-C2.3.md` |
| C2 | C2.4 | ✅ | (ใบนี้) | บันทึกการโทร + AI proposal (claim WORKING · ชาร์จครั้งเดียว CRM_ASSIST) · นามบัตร · แชท→กิจกรรม (dedupe · catch-up) · ปฏิทินรวมนัด (ตามช่วงเวลา · API key ไม่ได้) · เตือนงาน (anti-join · วนจนเงียบ) · ไฟล์เสียง PRIVATE ฟัง/ลบ · ข้อสอบ **91/91** (78+13) · ผู้ตรวจ: BLOCKER 2 → แก้ · PARITY ผ่าน · `wo-notes/crm-C2.4.md` |
...
| C2 | ปิด C2 (`qc:all`) | 🟡 | — | 325/355 (25 ก.ย.) · ENV ข้อภาพ 25 · **หนี้ `crm-c1.3` S0.3** (5 ไฟล์อ่าน CrmCompany ตรง) ต้องแก้ก่อน C3.1 · เช็ก acc-v2-coa T15 / kanban-k2.3 S3.2 |
| C3 | C3.0–C3.9 | ⏸️ | — | |
| C4 | C4.1–C4.4 | ⏸️ | — | |
| C5 | C5.1–C5.5 | ⏸️ | — | |
| C6 | C6.1–C6.4 | ⏸️ | — | |
