...
|---|---|---|---|---|
| C0 | C0.1 | ✅ | (ดู §12 ท้ายตาราง) | เครื่องมือ QC ครบ · ข้อสอบ C1.1 26→50 ข้อ · F14.1/F14.2 · `visual-crm` · `wo-notes/crm-C0.1.md` |
| C0 | C0.2–C0.5 | ⏸️ | — | ข้อสอบ C0.2 เขียนล่วงหน้าแล้ว |
