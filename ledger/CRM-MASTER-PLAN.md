...
| C0 | C0.2 | ✅ | (ดู commit ถัดไป) | facade `crm/index.ts` (re-export ล้วน) + ด่าน F2.3 · ข้อสอบ 27/27 · ORACLE-EDIT 2 รอบ |
| C0 | C0.3–C0.5 | ⏸️ | — | ถัดไป: C0.3 (facade บัญชี/แชท/HR/party/approval) |
