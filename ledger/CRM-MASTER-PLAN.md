...
| C1 | C1.1 | ✅ | (commit ถัดไป) | migration แรก `crm_v2_a` (ลง prod ตอน push) · ทีม · partyId 9 ตาราง (ผูกหลัง commit) · backfill 6 · ข้อสอบ 50/50 |
| C1 | C1.2a · C1.2b · C1.3–C1.11 | ⏸️ | — | ถัดไป C1.2a (engine ฟิลด์รับ objectKey) |
| C2 | C2.0–C2.11 | ⏸️ | — | |
| C3 | C3.0–C3.9 | ⏸️ | — | |
| C4 | C4.1–C4.4 | ⏸️ | — | |
| C5 | C5.1–C5.5 | ⏸️ | — | |
