...
| C0 | C0.3 | ✅ | (commit ถัดไป) | facade 6 โมดูล (บัญชี·แชท·HR·คลัง·party·approval) · ข้อสอบ 88/88 · เจอบั๊กเงิน 1 (ส่วนลดเกินยอด) แก้แล้ว |
| C0 | C0.4–C0.5 | ⏸️ | — | ถัดไป: C0.4 (ไฟล์ส่วนตัว) · C0.5 (ตัวกระจายงานรายนาที) |
| C1 | C1.1 · C1.2a · C1.2b · C1.3–C1.11 | ⏸️ | — | ข้อสอบ C1.1 พร้อม 50 ข้อ (ชื่อตารางแก้แล้วใน C0.1) · C1.1 ต้องสร้างแถวธุรกิจ 9 ตารางตาม `CQC.businessRows` + `crm/settings.ts` |
| C2 | C2.0–C2.11 | ⏸️ | — | |
| C3 | C3.0–C3.9 | ⏸️ | — | |
| C4 | C4.1–C4.4 | ⏸️ | — | |
| C5 | C5.1–C5.5 | ⏸️ | — | |
