#!/usr/bin/env bash
# C2.8 + C2.9 controller verification (Fable · 25 ก.ย.) — main tree = C2.1–C2.7 accepted + C2.8 (scoring) + C2.9 (business events) applied · QC1
# NO extra flock around build (with-gate-lock holds gate→qc2→qc3 for heavy work) · docs regen BEFORE m1.1 (F13.11)
set -uo pipefail
cd /root/projects/shark-crm
L=.qc-shots/crm/c28c29-verify.log; : > "$L"
...
q qc-crm-c2.8
q qc-crm-c2.9
for s in qc-crm-c2.1 qc-crm-c2.2 qc-crm-c2.3 qc-crm-c2.4 qc-crm-c2.5 qc-crm-c2.6 qc-crm-c2.7 qc-crm-c0.5 qc-crm-c1.2b qc-crm-c1.4 qc-crm-c1.5 qc-crm-c1.6 qc-crm-c1.8 qc-crm-c1.11 qc-crm-c2.0 qc-crm-v1 qc-crm-c0.2 qc-form qc-forms-notify qc-public-links qc-pages qc-pos-register qc-pos-account qc-acc-v2-payments qc-account-api-write-payments qc-member-fix-s3 qc-chat-core-v2 qc-member-m3.7 qc-ticket-money qc-ticket-cancel qc-rental qc-rental-race qc-rental-refund qc-school qc-school-refund qc-hotel-money qc-hotel-refund qc-clinic qc-clinic-refund qc-queue-public qc-shop qc-booking-race; do q "$s"; done
...
r "shots 2.8"     bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.8
