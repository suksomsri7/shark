#!/usr/bin/env bash
# C2.10 + C2.11 controller verification (Fable · 25 ก.ย.) — main tree = C2.1–C2.9 accepted + C2.10 + C2.11 applied · QC1
# NO extra flock around build (with-gate-lock holds gate→qc2→qc3 for heavy work) · docs regen BEFORE m1.1 (F13.11) · launch with the ABSOLUTE path
set -uo pipefail
cd /root/projects/shark-crm
L=.qc-shots/crm/c210c211-verify.log; : > "$L"
...
q qc-crm-c2.10
q qc-crm-c2.11
for s in qc-crm-c1.10 qc-crm-c2.1 qc-crm-c2.2 qc-crm-c2.3 qc-crm-c2.4 qc-crm-c2.5 qc-crm-c2.6 qc-crm-c2.7 qc-crm-c2.8 qc-crm-c2.9 qc-crm-c0.5 qc-crm-c1.2b qc-crm-c1.4 qc-crm-c1.5 qc-crm-c1.6 qc-crm-c1.7 qc-crm-c1.8 qc-crm-c1.11 qc-crm-c2.0 qc-crm-v1 qc-crm-c0.2 qc-form qc-forms-notify qc-public-links qc-pages qc-pos-register qc-pos-account qc-acc-v2-payments qc-account-api-write-payments qc-account-api-keys qc-webhook qc-kanban-notify qc-push qc-cron qc-member-fix-s3 qc-member-m3.3 qc-member-m3.6 qc-member-m3.7 qc-chat-core-v2 qc-ticket-money qc-rental qc-school qc-hotel-money qc-clinic qc-queue-public qc-shop qc-booking-race; do q "$s"; done
...
r "shots 2.10 (owner)"   bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.10
r "shots 2.10 (manager)" bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.10 --user manager
r "shots 2.11 (owner)"   bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.11
