...
L=.qc-shots/crm/c26c27-verify.log; : > "$L"
...
q qc-crm-c2.6
q qc-crm-c2.7
for s in qc-crm-c2.1 qc-crm-c2.2 qc-crm-c2.3 qc-crm-c2.4 qc-crm-c2.5 qc-crm-c0.5 qc-crm-c1.2b qc-crm-c1.4 qc-crm-c1.5 qc-crm-c1.6 qc-crm-c1.8 qc-crm-c1.11 qc-crm-c2.0 qc-crm-v1 qc-crm-c0.2 qc-form qc-forms-notify qc-public-links qc-pages qc-pos-register qc-pos-account qc-acc-v2-payments qc-account-api-write-payments qc-member-fix-s3 qc-chat-core-v2; do q "$s"; done
...
r "shots 2.6"     bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.6
r "shots 2.7"     bash scripts/with-gate-lock.sh pnpm exec tsx scripts/visual-crm.mts 2.7
