...
for u in owner thana nok manager; do r "shots $u" pnpm exec tsx scripts/visual-crm.mts 1.6 --user $u; done
...
r "shots 1.5 owner" pnpm exec tsx scripts/visual-crm.mts 1.5 --user owner
