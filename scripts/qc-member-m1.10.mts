...
try {
  ...
  chk("M1.10-S3.4", "🔴 parity ภาพ 04 + 15 — Fable ตรวจด้วยตา · wo-notes/member-M1.10.md มี 'PARITY: ผ่าน'", /^\s*-?\s*\*\*PARITY:\s*ผ่าน\*\*/m.test(read("ledger/wo-notes/member-M1.10.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
