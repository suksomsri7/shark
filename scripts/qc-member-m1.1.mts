...
try {
  ...
  chk("M1.1-S1.5", "ตารางใหม่ M1 18 ตาราง (§4.3) มี id tenantId createdAt · ตารางที่แก้ได้มี updatedAt (ตาราง M2/M3 เกิดที่ migration ของตัวเอง)", tblMiss.length === 0 /* เดิมบังคับว่ายังไม่มีตาราง M2/M3 — ตัดออก 11 ก.ย. 2569 หลังเฟส M2 สร้างแล้ว */, "ครบ 18", tblMiss.join(",") || "-");
