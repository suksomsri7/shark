...
try {
  ...
  chk("M3.3-S9.4", "🔴 parity ภาพ 07 (บน) + 22 — Fable ตรวจด้วยตา · wo-notes/member-M3.3.md มี 'PARITY: ผ่าน'", /PARITY:\s*ผ่าน/.test(read("ledger/wo-notes/member-M3.3.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
