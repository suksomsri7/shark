...
try {
  ...
  chk("K1.1-S1.5", "enum ใหม่ 3 ตัว: Visibility PRIVATE,TENANT · LabelColor 6 สี · SourceType 7 ค่า", en.KanbanBoardVisibility === "PRIVATE,TENANT" && en.KanbanLabelColor === "SLATE,BLUE,GREEN,AMBER,RED,PURPLE" && String(en.KanbanCardSourceType ?? "").startsWith("MANUAL,TEMPLATE,CHAT,FORM,EMAIL,AUTOMATION,AI") /* ORACLE-EDIT K1.1-S1.5 (ใบ M3.4): enum ต่อท้าย REVIEW ได้ — 7 ค่าเดิมต้องครบตามลำดับ */, "ตามสัญญา", JSON.stringify(en));
