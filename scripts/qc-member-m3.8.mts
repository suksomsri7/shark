...
try {
  ...
  chk("M3.8-S11.3", "🔴 parity ภาพ 25 — Fable ตรวจด้วยตา · wo-notes/member-M3.8.md มี 'PARITY: ผ่าน'", /PARITY:\s*ผ่าน/.test(read("ledger/wo-notes/member-M3.8.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
