...
try {
  ...
  chk("M3.5-S7.4", "🔴 parity ภาพ 24 + 08 (ขวา) — Fable ตรวจด้วยตา · wo-notes/member-M3.5.md มี 'PARITY: ผ่าน'", /PARITY:\s*ผ่าน/.test(read("ledger/wo-notes/member-M3.5.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
