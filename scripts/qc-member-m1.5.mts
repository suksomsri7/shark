...
try {
  ...
  chk("M1.5-S4.5", "🔴 parity ภาพ 01 + 02 — Fable ตรวจด้วยตา · wo-notes/member-M1.5.md มี 'PARITY: ผ่าน'", /^\s*-?\s*\*\*PARITY:\s*ผ่าน\*\*/m.test(read("ledger/wo-notes/member-M1.5.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
