...
try {
  ...
  chk("M3.6-S8.4", "🔴 parity ภาพ 30 — Fable ตรวจด้วยตา · wo-notes/member-M3.6.md มี 'PARITY: ผ่าน'", /PARITY:\s*ผ่าน/.test(read("ledger/wo-notes/member-M3.6.md")), "PARITY: ผ่าน", "ยังไม่ได้ตรวจภาพ", "MAJOR");
} catch (e) {
  console.error("💥", e);
