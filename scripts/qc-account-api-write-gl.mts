...
if (!((await import("@/lib/modules/account/api/registry" as string)) as { ACCOUNT_OPS: { id: string }[] }).ACCOUNT_OPS.some((o) => o.id === "journal.create")) {
  console.log("⚠️  SKIPPED — WO ยังไม่สร้าง (journal.create)");
