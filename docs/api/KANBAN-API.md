...
| `customer_scope` | 403 | A customer session (member self-service) called an operation that belongs to the shop. Member module only. | Nothing to do here; a shop API key never gets this code. |
